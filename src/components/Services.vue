    ...
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-8 mb-32">
        <div v-for="(service, index) in services" :key="service.title"
          ...
          <div
            class="w-14 h-14 rounded-xl bg-cyan-50 flex items-center justify-center mb-8 group-hover:bg-cyan-400 group-hover:text-white transition-colors duration-300">
            <component :is="service.icon"
              class="w-7 h-7 text-cyan-500 group-hover:text-white transition-colors duration-300" />
          </div>
          ...
          <ul class="space-y-3 pt-6 border-t border-gray-100">
            <li v-for="feature in service.features" :key="feature"
              class="flex items-center gap-3 text-content text-sm font-medium">
      ...
      <div id="process" class="bg-white rounded-3xl border border-gray-200 p-12 lg:p-16">
        ...
        <div class="grid md:grid-cols-4 gap-8 relative">
          ...
          <div class="relative pt-4">
            <div
              class="w-16 h-16 rounded-full bg-white border-4 border-gray-100 flex items-center justify-center text-xl font-bold text-content mb-6 mx-auto relative z-10 shadow-sm">
              01</div>
          ...
          <div class="relative pt-4">
            <div
              class="w-16 h-16 rounded-full bg-white border-4 border-cyan-400 flex items-center justify-center text-xl font-bold text-cyan-500 mb-6 mx-auto relative z-10 shadow-lg shadow-cyan-400/30">
              03</div>
